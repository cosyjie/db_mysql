...
wget https://dev.mysql.com/get/mysql84-community-release-el9-1.noarch.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/

cd /opt/cosyjieserver/tmp/db_mysql/download && yum install -y mysql84-community-release-el9-1.noarch.rpm
