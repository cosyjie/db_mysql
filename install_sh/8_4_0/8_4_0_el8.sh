...
wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-community-server-8.4.0-1.el8.x86_64.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-community-client-8.4.0-1.el8.x86_64.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-community-client-plugins-8.4.0-1.el8.x86_64.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-community-icu-data-files-8.4.07-1.el8.x86_64.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-community-common-8.4.0-1.el8.x86_64.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-community-libs-8.4.0-1.el8.x86_64.rpm -P /opt/cosyjieserver/tmp/db_mysql/download/
