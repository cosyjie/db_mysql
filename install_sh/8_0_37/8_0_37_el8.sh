...
wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-community-server-8.0.37-1.el8.x86_64.rpm -P /opt/jieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-community-client-8.0.37-1.el8.x86_64.rpm -P /opt/jieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-community-client-plugins-8.0.37-1.el8.x86_64.rpm -P /opt/jieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-community-icu-data-files-8.0.37-1.el8.x86_64.rpm -P /opt/jieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-community-common-8.0.37-1.el8.x86_64.rpm -P /opt/jieserver/tmp/db_mysql/download/
wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-community-libs-8.0.37-1.el8.x86_64.rpm -P /opt/jieserver/tmp/db_mysql/download/
